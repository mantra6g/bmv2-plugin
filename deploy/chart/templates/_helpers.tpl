...
*/}}
{{- define "iml-bmv2-plugin.fullname" -}}
...
*/}}
{{- define "iml-bmv2-plugin.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "iml-bmv2-plugin.resourceName" -}}
{{- $fullname := include "iml-bmv2-plugin.fullname" .context }}
{{- $suffix := .suffix }}
