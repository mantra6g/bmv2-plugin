...
import (
	...
	nf2 "github.com/mantra6g/bmv2-plugin/internal/managers/nf"
	"github.com/mantra6g/bmv2-plugin/internal/managers/nfcfg"
	"github.com/mantra6g/bmv2-plugin/internal/managers/p4target"
	"github.com/mantra6g/bmv2-plugin/pkg/strutils"
...
func isDeleted(status nf2.DeploymentStatus) bool {
	return status.Phase == nf2.PhaseDeleted
}

func isDeployed(status nf2.DeploymentStatus) bool {
	return status.Phase == nf2.PhaseReady
}
...
func (r *Reconciler) updateStatus(networkFunction *corev1alpha1.NetworkFunction,
	depStatus nf2.DeploymentStatus, funcIP netip.Prefix) error {
...
func calculateStatus(netFunc *corev1alpha1.NetworkFunction,
	depStatus nf2.DeploymentStatus, funcIP netip.Prefix) corev1alpha1.NetworkFunctionStatus {
	// Calculate Phase
