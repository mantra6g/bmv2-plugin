...
import (
	...
	"github.com/mantra6g/bmv2-plugin/pkg/p4rutils"
...
func (m *RealManager) fetchTableMetadata(ctx context.Context) ([]api2.TableMetadata, error) {
	...
	return api2.GetTableMetadata(&api2.P4Program{P4Info: resp.Config.P4Info}), nil
}
